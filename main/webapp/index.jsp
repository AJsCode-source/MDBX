...
<head>
    ...
    <meta name="keywords" content="Movie, unica, creative, html">
            ...
            <div class="row">
                <div class="col-lg-2">
                    <div class="header__logo">
                        <a href="./index.jsp">
                            <img src="img/logo22.png" alt="" height="100rem">
                        </a>
                    </div>
                </div>
                <div class="col-lg-8">
                            ...
                            <ul>
                                ...
                                <li><a href="./categories.jsp">Categories <span class="arrow_carrot-down"></span></a>
                                    <ul class="dropdown">
                                        ...
                                        <li><a href="./Movie-watching.jsp">Movie Watching</a></li>
    ...
    <section class="hero">
        <div class="container">
            <div class="hero__slider owl-carousel">
                <div class="hero__items set-bg" data-setbg="img/hero/smug.png">
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="hero__text">
                                <div class="label">Adventure</div>
                                <h2>Adventure Time</h2>
                                <p>Twelve- year-old Finn battles evil in the Land of Ooo...</p>
                                <a href="#"><span>Watch Now</span> <i class="fa fa-angle-right"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="hero__items set-bg" data-setbg="img/hero/nah_id_win.jpg">
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="hero__text">
                                <div class="label">Adventure</div>
                                <h2 style="color:black">Jujutsu Kaisen</h2>
                                <p style="color:black">He did not win. Bro got cooked...</p>
                                <a href="#"><span>Watch Now</span> <i class="fa fa-angle-right"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="hero__items set-bg" data-setbg="img/hero/2049.png">
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="hero__text">
                                <div class="label">Adventure</div>
